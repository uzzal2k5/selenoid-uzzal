...
var _optionsSerializer = require('../utils/optionsSerializer');
...
const DockerEvents = {
     ...
     */
    init(options = {}) {
        const cmdOptions = (0, _deepMerge2.default)({}, DEFAULT_OPTIONS, options);
        const cmd = [CMD].concat((0, _optionsSerializer2.default)(cmdOptions)).join(' ');
        const buffer = [];
