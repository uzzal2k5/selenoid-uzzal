...
const COLORS = {
    INFO: _chalk2.default.hex('#6495ED'),
    ERROR: _chalk2.default.keyword('crimson'),
    WARN: _chalk2.default.keyword('orange'),
    LOG: _chalk2.default.gray
};
...
//# sourceMappingURL=colorLogger.js.map